<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
                <form method="get" action="<?=base_url()."index.php/charge"?>">
                    <div class="row">
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Historique de charges</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse">
                        <i class="fa fa-minus"></i>
                    </button>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <a href="<?=base_url()?>index.php/charge/ajouter" class="btn btn-primary" style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if($val["methode"] == 2 || $val["methode"] == 3):
                                            $cheque = getPaiementDetails($val["id_charge"], "charge");
                                        ?>
                                            <br> [ <?=$cheque->reference." &nbsp-&nbsp ".date("d/m/Y", strtotime($cheque->date_cheque))?> ]
                                        <?php endif; ?>
                                    </td>
                                    <td class="current-width no-export">
                                        <a href="<?=base_url()."index.php/charge/modifier/".$val["id_charge"];?>" class="btn btn-success rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Modifier">
                                            <i class="fa fa-wrench" aria-hidden="true"></i>
                                        </a>
                                        <?php if($this->session->userdata("role_user") == 1): ?>
                                            <form method="post" action="<?=base_url()."index.php/charge/supprimer/"?>" id="form_<?=$val["id_charge"]?>" style="display:none;">
                                                <input type="hidden" name="id_charge" value="<?=$val["id_charge"]?>">
                                            </form>
                                            <a href="#" onclick="confirmDelete('<?="form_".$val["id_charge"]?>')" class="btn btn-danger btn-sm rounded" data-toggle="tooltip" data-placement="top" title="Supprimer">
