<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
                <form method="get" action="<?=base_url()."index.php/caisse/cheques_fournisseur"?>">
                    <div class="row">
                        ...
                        <table id="myDataTable_1" class="table myDataTable table-bordered table-striped">
                            ...
                            <?php foreach ($cheques as $val): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=base_url()."index.php/client/details/".$val["id_fournisseur"]?>"><strong><?=$val["fournisseur"]?></strong></a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="current-width no-export">
                                        ...
                                        <form method="post" action="<?=base_url()."index.php/caisse/cheques_fournisseur"?>" id="form_<?=$val["id_cheque"]?>" style="display:none;">
                                        ...
                                        <a href="#" onclick="confirmPaid('<?=$val["id_cheque"]?>', '<?=$val["reference"]?>')" class="btn btn-sm btn-primary rounded" data-toggle="tooltip" data-placement="top" title="Prenez Paiement">
...
<!--                            <th class="current-width no-export">Options</th>-->
                            ...
                            <?php foreach ($historique as $val): ?>
                                <tr>
                                    ...
                                    <td><?=getChequeStatus($val["paid"],$val["caisse"])?></td>
                                    <?php /*<td class="current-width no-export">
                                        <form method="post" action="<?=base_url()."index.php/caisse/cheques_fournisseur"?>" id="form_<?=$val["id_cheque"]?>" style="display:none;">
                                            <input type="hidden" name="id_cheque" value="<?=$val["id_cheque"]?>">
                                            <input type="hidden" name="code_vente" value="<?=$val["code_vente"]?>">
                                            <input type="hidden" name="code_avoir" value="<?=$val["code_avoir"]?>">
...
<script type="text/javascript">
    ...
    function confirmPaid(id, reference, caisse = 0)
    {
        Swal.fire({
            title: 'Payé le chèque/Effet: ' + reference ,
