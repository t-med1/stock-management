<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
                <form method="get" action="<?=base_url()."index.php/production"?>">
                    <div class="row">
                            ...
                            <?php foreach ($productions as $val): ?>
                                <tr>
                                    ...
                                    <td class="current-width no-export">
                                        <a href="<?=base_url()."index.php/production/details/".$val["id_production"]?>" class="btn btn-primary rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Détails">
                                            <i class="fa fa-list-alt" aria-hidden="true"></i>
                                        </a>
                                        <a href="<?=base_url()."index.php/production/modifier/".$val["id_production"];?>" class="btn btn-success rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Modifier">
                                            <i class="fa fa-wrench" aria-hidden="true"></i>
                                        </a>
                                        <?php if($this->session->userdata("role_user") == 1): ?>
                                            <form method="post" action="<?=base_url()."index.php/production/supprimer/"?>" id="form_<?=$val["id_production"]?>" style="display:none;">
                                                <input type="hidden" name="id_production" value="<?=$val["id_production"]?>">
                                            </form>
                                            <a href="#" onclick="confirmDelete('<?="form_".$val["id_production"]?>')" class="btn btn-danger btn-sm rounded" data-toggle="tooltip" data-placement="top" title="Supprimer">
