<form method="post" action="<?=base_url()?>index.php/production/nouvelle">
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Nouvelle Production</h3>
                ...
                <div class="box-body">
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="code_production" id="code_production" value="<?=$code_production?>" placeholder="Code Production" readonly required>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 15px; margin-bottom: 10px;">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" name="date_production" value="<?=date("Y-m-d")?>" placeholder="Date de production" required>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 15px; margin-bottom: 10px;">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-6">
                            <input type="number" step="any" min="0.1" class="form-control" name="quantite" id="quantite" value="1" placeholder="Qunatité" required>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $("form").on("submit", function (event) {
            ...
            var form = this;
            checkCodeExists("production", "", function () {
