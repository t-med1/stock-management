...
<head>
    ...
    <style rel="stylesheet" type="text/css">
        ...
        /* CSS for inline buttons in the "Options" column */
            ...
            <ul class="sidebar-menu" data-widget="tree" style="margin-top: 5px;">
                ...
                <li class="treeview <?=$active=="CL"||$active=="CL-ADD"?"active":""?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?=$active=="CTL"?"active":""?>"><a href="<?=base_url()?>index.php/client/cite"><i class="fa fa-fw fa-long-arrow-right"></i>&nbsp; Liste de Cites</a></li>
...
<!--                --><?php //endif; ?>
                ...
                <li class="treeview <?=$active=="VT"||$active=="VT-RPD"||$active=="VT-ADD"||$active=="VT-DV"||$active=="VT-CMD"?"active":""?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?=$active=="VT-TST"?"active":""?>"><a href="<?=base_url()?>index.php/vente/teste"><i class="fa fa-fw fa-long-arrow-right"></i>&nbsp; Vente Teste</a></li>
                ...
                <li class="treeview <?=$active=="RP-SA"||$active=="RP-SR"||$active=="RP-PV"||$active=="RP-RGC"||$active=="RP-RGF"||$active=="RP-UD"||$active=="RP-RFB"||$active=="RP-CA"?"active":""?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?=$active=="RP-CM"?"active":""?>"><a href="<?=base_url()?>index.php/admin/commande"><i class="fa fa-fw fa-long-arrow-right"></i>&nbsp; Rapport Commandes</a></li>
