<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
                <form method="get" action="<?=base_url()."index.php/commande"?>">
                    <div class="row">
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Liste de Commandes Fournisseurs</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse">
                        <i class="fa fa-minus"></i>
                    </button>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <a href="<?=base_url()?>index.php/commande/ajouter" class="btn btn-primary" style="width:100%;">
                            ...
                            <?php foreach ($commandes as $val): ?>
                                <tr>
                                    ...
                                    <td class="current-width no-export">
                                        <a href="<?=base_url()."index.php/commande/details/".$val["id_commande"]?>" class="btn btn-primary rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Détails">
                                            <i class="fa fa-list-alt" aria-hidden="true"></i>
                                        </a>
                                        <a href="<?=base_url()."index.php/commande/bon_commande/".$val["id_commande"]?>" target="_blank" class="btn btn-warning rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Imprimer">
                                            <i class="fa fa-print" aria-hidden="true"></i>
                                        </a>
                                        <a href="<?=base_url()."index.php/commande/modifier/".$val["id_commande"];?>" class="btn btn-success rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Modifier">
                                            <i class="fa fa-wrench" aria-hidden="true"></i>
                                        </a>
                                        <?php if($this->session->userdata("role_user") == 1): ?>
                                            <form method="post" action="<?=base_url()."index.php/commande/supprimer/"?>" id="form_<?=$val["id_commande"]?>" style="display:none;">
                                                <input type="hidden" name="id_commande" value="<?=$val["id_commande"]?>">
                                            </form>
                                            <a href="#" onclick="confirmDelete('<?="form_".$val["id_commande"]?>')" class="btn btn-danger btn-sm rounded" data-toggle="tooltip" data-placement="top" title="Supprimer">
