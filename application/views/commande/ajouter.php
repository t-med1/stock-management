<form method="post" action="<?=base_url()?>index.php/commande/ajouter">
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="code_commande" id="code_commande" placeholder="Code Commande de Fournisseur" readonly required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="date_commande" value="<?=date("Y-m-d")?>" placeholder="Date de Commande de Fournisseur" required>
                            </div>
                            <div class="form-group">
    ...
    $(document).ready(function ()
    {
        ...
        $("form").on("submit", function (event) {
            ...
            if($("[name='id_produit[]']").length > 0) {
                $("#alert_produit").hide();
                checkCodeExists("commande", "", function () {
