<div class="row">
    ...
    <form method="post" action="<?=base_url()?>index.php/transport/ajouter">
        <div class="col-md-6">
            <div class="box box-default box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Ajouter Transport</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="code_transport" id="code_transport" placeholder="Code Transport" readonly required>
                                <span style="color: red; display: none;" id="code_transport_exists"></span>
                            </div>
                            <div class="form-group">
                                <label>Nom de Livreur :</label>
                                <input type="text" class="form-control" name="livreur" placeholder="Nom de Livreur">
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $("form").on("submit", function (event) {
            ...
            var form = this;
            checkCodeExists("transport", "", function () {
