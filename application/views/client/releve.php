    ...
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 style="padding: 0px 0px 0px 8px; font-size: 2.2rem;">Client : &nbsp; <strong><a href="<?=base_url()."index.php/client/details/".$client->id_client?>"><?=$client->full_name?></a></strong></h4>
                    </div>
                    <div class="col-md-6">
                        ...
                        <table id="myDataTable" class="table myDataTable table-bordered">
                            ...
                            <?php if(_ENABLE_AVANCE_): ?>
                                <tr class="text-warning">
                                    <td colspan="6" style="font-size: 14px !important;"><strong>Avance Reste : &nbsp; <?=number_format(getAvanceTotal($client->id_client)["total_avance"],2,'.',' ')?></strong> <small>DH</small></td>
                                    <td hidden>-</td>
                                    <td hidden>-</td>
                                    <td hidden>-</td>
                                    <td hidden>-</td>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        createDataTable(
            ...
            null,
            "#export_btns",
            "Relevé de Client : &nbsp; <?=$client->full_name?>",
            "R" // relevé
        );
