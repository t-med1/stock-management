<form method="post" action="<?=base_url()?>index.php/demontage/modifier">

    <input type="hidden" name="id_demontage" value="<?=$demontage->id_demontage?>">

    <div class="row">
        <div class="col-md-12">
            <div class="box box-default box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Modifier Démontage</h3>
                ...
                <div class="box-body">
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-md-3">
                            <label style="float: right; margin-top: 8px;"><span class="text-red" data-toggle="tooltip" title="Obligatoire">*</span> Code demontage :</label>
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="code_demontage" id="code_demontage" value="<?=$demontage->code_demontage?>" placeholder="Code Démontage" readonly required>
                            <span style="color: red; display: none;" id="code_demontage"></span>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 15px; margin-bottom: 10px;">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" name="date_demontage" value="<?=date("Y-m-d", strtotime($demontage->date_demontage))?>" placeholder="Date de démontage" required>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 15px; margin-bottom: 10px;">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-6">
                            <input type="number" step="any" min="0.1" class="form-control" name="quantite" id="quantite" value="<?=$demontage->quantite?>" placeholder="Qunatité" required>
                        </div>
                    </div>
                    <div class="row text-danger" style="margin-top: 15px; margin-bottom: 10px;">
                        ...
                        <div class="col-md-6">
                            <input type="number" step="any" min="0" class="form-control" name="frais" value="<?=$demontage->frais?>" placeholder="Frais" style="border: 1px solid #a94442" required>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="remarque" class="form-control" maxlength="200" rows="3"><?=$demontage->remarque?></textarea>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $("#id_produit_search").val("<?=$demontage->produit?>").trigger("input");

        createCodeChecker(
            "demontage",
            "DM",
            "<?=$demontage->code_demontage?>",
            <?=$demontage->id_demontage?>
        );

        $("form").on("submit", function (event) {
            event.preventDefault();
            var form = this;
            checkCodeExists("demontage", <?=$demontage->id_demontage?>, function () {
