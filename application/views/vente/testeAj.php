<form method="post" action="<?= base_url() ?>index.php/vente/<?= !empty($type_vente) && $type_vente == "rapide" ? "rapide" : "teste" ?>">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="margin-top: 15px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <label style="float: right; margin-top: 8px;"><span class="text-red" data-toggle="tooltip" title="Obligatoire">*</span> cité :</label>
        ...
        <!--                                            data-livreur="--><? //=$val["livreur"]?><!--"-->
                    ...
                    <div class="row" style="margin-top: 15px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <label style="float: right; margin-top: 8px;"><span class="text-red" data-toggle="tooltip" title="Obligatoire">*</span> Date :</label>
                                ...
                                if (!empty($object_details)):
                                    ...
                                    foreach ($object_details as $val):
                                        ...
                                        if (!$val['id_service']):
                                            ...
                                            $stock = getQuantiteProduit($val["id_produit"]);

                                            $min = $stock <= 0 ? 0 : 0.1;

                                            if (!empty($val["prix_vente"])):
...
<script type="text/javascript">
    ...
    if (!isNaN(total) && !isNaN(billet)) {
        ...
        $('#change').val(''); // Clear the change value
        $('#vente_reste').val(''); // Clear the vente_reste value
        $('#vente_paiement').val(''); // Clear the vente_paiement value
    }
}
